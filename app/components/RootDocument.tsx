    ...
    : schemaLocale === "es"
      ...
      : schemaLocale === "de"
        ...
        : schemaLocale === "fr"
          ...
          : schemaLocale === "vi"
            ? {
                products: ["Tạ tay", "Bánh tạ", "Đĩa tạ bumper", "Phụ kiện phòng gym"],
                websiteName: "PowerBaseFit nhà sản xuất thiết bị phòng gym chuyên nghiệp",
                businessDescription: "PowerBaseFit sản xuất tạ tay, bánh tạ và phụ kiện cho nhà nhập khẩu, nhà phân phối, thương hiệu riêng và dự án phòng gym."
              }
            : schemaLocale === "sv"
              ? {
                  products: ["Hantlar", "Viktskivor", "Bumpervikter", "Gymtillbehör"],
                  websiteName: "PowerBaseFit tillverkare av professionell gymutrustning",
                  businessDescription: "PowerBaseFit tillverkar hantlar, viktskivor, bumpervikter och tillbehör för importörer, distributörer, egna varumärken och kommersiella gymprojekt."
                }
            : schemaLocale === "it"
              ? {
                  products: ["Manubri", "Dischi pesi", "Dischi bumper", "Accessori palestra"],
                  websiteName: "PowerBaseFit produttore di attrezzature fitness professionali",
                  businessDescription: "PowerBaseFit produce manubri, dischi pesi, bumper e accessori per importatori, distributori, marchi privati e progetti palestra."
                }
            : schemaLocale === "ko"
              ? {
                  products: ["상업용 덤벨", "웨이트 원판", "범퍼 플레이트", "헬스장 액세서리"],
                  websiteName: "PowerBaseFit 상업용 헬스기구 제조업체",
                  businessDescription: "PowerBaseFit는 한국 수입업체, 유통사, 자체 브랜드와 헬스장 프로젝트를 위해 덤벨, 원판, 범퍼 플레이트와 액세서리를 제조·공급합니다."
                }
            : schemaLocale === "id"
              ? {
            ...
            : schemaLocale === "pl"
              ? {
                  products: ["Hantle komercyjne", "Obciążenia olimpijskie", "Talerze bumper", "Akcesoria fitness"],
            ...
            : schemaLocale === "nl"
              ? {
                  products: ["Commerciële halters", "Halterschijven", "Bumper plates", "Fitnessaccessoires"],
