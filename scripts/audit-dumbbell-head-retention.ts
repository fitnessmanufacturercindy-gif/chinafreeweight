...
console.log(`Dumbbell head retention guide audit passed: ${publishedLocales.length} localized editions, ${expectedImageCount} optimized images and ${expectedFaqCount} FAQs each.`);
