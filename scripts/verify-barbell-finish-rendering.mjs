...
const routes = [
  ["en", "/resources/olympic-barbell-coating-finish-guide"],
  ["pt-BR", "/pt/blog/acabamento-barra-olimpica-cromo-zinco-cerakote"],
  ["es", "/es/blog/acabado-barra-olimpica-cromo-zinc-cerakote"],
  ["de", "/de/blog/langhantel-beschichtung-hartchrom-zink-cerakote"],
  ["fr", "/fr/blog/revetement-barre-olympique-chrome-zinc-cerakote"],
  ["vi", "/vi/blog/lop-phu-don-ta-olympic-chrome-kem-cerakote"],
  ["sv", "/sv/blogg/skivstang-ytbehandling-hardkrom-zink-cerakote"],
  ["it", "/it/blog/finitura-bilanciere-cromo-zinco-cerakote"],
  ["nl", "/nl/blog/halterstang-coating-hardchroom-zink-cerakote"],
  ["ar", "/ar/blog/talaa-qadib-athqal-olimbi-krom-zink-cerakote"],
  ["ko", "/ko/blog/olympic-barbell-coating-guide"],
  ["id", "/id/blog/lapisan-barbel-olimpik-hard-chrome-zinc-cerakote"],
  ["pl", "/pl/blog/powloka-gryfu-chrom-cynk-cerakote"],
];
...
const imageFragment = "/assets/resources/barbell-finishes/";
const artifactDirectory = path.join(process.cwd(), ".artifacts", "barbell-finish-2026-09-05");
...
async function inspectPage(page, locale, route, viewportLabel, checkLinks = false) {
  ...
  if (result.heroPath !== `${imageFragment}${locale.toLowerCase()}-olympic-barbell-finishes.webp`) failures.push(`${route}: incorrect locale hero ${result.heroPath}`);
...
console.log(`Barbell-finish rendering verified: ${routes.length}/13 pages, desktop/tablet/mobile, images, links, canonical, hreflang, schema and RTL.`);
