...
const routes = [
  ["en", "/resources/olympic-barbell-knurling-guide-commercial-gym"],
  ["pt-BR", "/pt/blog/recartilhado-barra-olimpica-academia"],
  ["es", "/es/blog/moleteado-barra-olimpica-gimnasio"],
  ["de", "/de/blog/langhantel-raendelung-fitnessstudio-einkauf"],
  ["fr", "/fr/blog/moletage-barre-olympique-salle-de-sport"],
  ["vi", "/vi/blog/van-nham-don-ta-olympic-phong-gym"],
  ["sv", "/sv/blogg/skivstang-lattring-gym-inkop"],
  ["it", "/it/blog/zigrinatura-bilanciere-olimpico-palestra"],
  ["nl", "/nl/blog/halterstang-karteling-sportschool-inkoop"],
  ["ar", "/ar/blog/barbell-knurling-commercial-gym-guide"],
  ["ko", "/ko/blog/olympic-barbell-knurling-commercial-gym"],
  ["id", "/id/blog/knurling-barbel-olimpiade-gym"],
  ["pl", "/pl/blog/moletowanie-gryfu-olimpijskiego-silownia"],
];
...
const imageFragment = "/assets/resources/barbell-knurling/";
const artifactDirectory = path.join(process.cwd(), ".artifacts", "barbell-knurling-2026-09-07");
...
async function inspectPage(page, locale, route, viewportLabel, checkLinks = false) {
  ...
  if (result.heroPath !== `${imageFragment}${locale.toLowerCase()}-barbell-knurling.webp`) failures.push(`${route}: incorrect locale hero ${result.heroPath}`);
...
console.log(`Barbell-knurling rendering verified: ${routes.length}/13 pages, desktop/tablet/mobile, images, links, canonical, hreflang, schema and RTL.`);
