...
SOURCE = Path("D:/xwechat_files/wxid_k2g3trzr89ou22_5ad9/temp/RWTemp/2026-07/14734a7e69ab9e8100c8a4f2b8fd31ed.jpg")
OUT_DIR = ROOT / "public" / "assets" / "products" / "weight-plates" / "heavy-solid-steel"
OUTPUT = OUT_DIR / "heavy-solid-steel-plate-main.jpg"
SHEET = ROOT / "outputs" / "heavy-solid-steel-plate-white-bg-sheet.jpg"
...
def main() -> None:
    ...
    width, height = image.size
    image = image.crop((int(width * 0.02), int(height * 0.05), int(width * 0.98), int(height * 0.92)))
