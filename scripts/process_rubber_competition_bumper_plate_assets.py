...
SOURCE = Path("D:/xwechat_files/wxid_k2g3trzr89ou22_5ad9/temp/RWTemp/2026-07/272cda64429277b345aafb6b97872fb5.jpg")
OUT_DIR = ROOT / "public" / "assets" / "products" / "weight-plates" / "rubber-competition-bumper"
OUTPUT = OUT_DIR / "rubber-competition-bumper-plate-main.jpg"
SHEET = ROOT / "outputs" / "rubber-competition-bumper-plate-white-bg-sheet.jpg"
...
def main() -> None:
    ...
    width, height = image.size
    image = image.crop((int(width * 0.03), int(height * 0.14), int(width * 0.97), int(height * 0.94)))
