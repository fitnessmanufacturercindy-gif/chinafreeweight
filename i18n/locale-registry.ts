...
const definitions: readonly LocaleDefinition[] = [
  ...
  { routeLocale: "pt", internalLocale: "pt-BR", hreflang: "pt-BR", englishName: "Portuguese (Brazil)", nativeName: "Português (Brasil)", direction: "ltr", prefix: "/pt", enabled: true, public: false, default: false, fallbackLocale: "en" },
  { routeLocale: "es", internalLocale: "es", hreflang: "es", englishName: "Spanish", nativeName: "Español", direction: "ltr", prefix: "/es", enabled: true, public: false, default: false, fallbackLocale: "en" },
